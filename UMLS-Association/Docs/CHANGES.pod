##################################################################
#
#    CHANGES for the MMB-Interface Package
#    $Id: CHANGES.pod,v 0.01 2014/06/27 13:23:47 btmcinnes Exp $ 
#################################################################
...
Fixed a bug with CUICollector.pl, and multiple other bugs with user-defined
parameters.

Added the --getdescendents argument

=head2 Changes from version 0.09 to 0.10

CPAN conflicts, needed to rename, otherwise same as 0.10

=head2 Changes from version 0.10 to 0.11
